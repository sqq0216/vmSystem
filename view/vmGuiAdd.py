...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, _translate("Dialog", "新建项目1", None))
        self.comboBox.setItemText(1, _translate("Dialog", "新建项目2", None))
        self.comboBox.setItemText(2, _translate("Dialog", "新建项目3", None))
