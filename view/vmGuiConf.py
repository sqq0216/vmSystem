...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox_systype.addItem(_fromUtf8(""))
        self.comboBox_systype.addItem(_fromUtf8(""))
        self.comboBox_systype.addItem(_fromUtf8(""))
        self.comboBox_systype.addItem(_fromUtf8(""))
        self.comboBox_systype.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_systype.setItemText(0, _translate("Form", "新建项目", None))
        self.comboBox_systype.setItemText(1, _translate("Form", "新建项目", None))
        self.comboBox_systype.setItemText(2, _translate("Form", "新建项目", None))
        self.comboBox_systype.setItemText(3, _translate("Form", "新建项目", None))
        self.comboBox_systype.setItemText(4, _translate("Form", "新建项目", None))
        self.comboBox_systype.setItemText(5, _translate("Form", "新建项目", None))
